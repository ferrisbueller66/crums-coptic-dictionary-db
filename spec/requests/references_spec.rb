...
RSpec.describe "/references", type: :request do
  ...
  # ReferencesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get references_url, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested reference" do
      reference = Reference.create! valid_attributes
      expect {
        delete reference_url(reference), headers: valid_headers, as: :json
      }.to change(Reference, :count).by(-1)
    end
  end
end
